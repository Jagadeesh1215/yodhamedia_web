...
const config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-gradient": "linear-gradient(135deg, #080514 0%, #1E1245 50%, #080514 100%)",
        ...
        "card-gradient": "linear-gradient(145deg, rgba(45,27,105,0.4), rgba(18,13,46,0.8))",
      },
      animation: {
      ...
      keyframes: {
        ...
        pulseGold: {
          ...
          "50%": { boxShadow: "0 0 50px rgba(201,145,13,0.7), 0 0 80px rgba(201,145,13,0.3)" },
        },
        spinReverse: {
      ...
      boxShadow: {
        ...
        "gold-glow": "0 0 60px rgba(201,145,13,0.5), 0 0 120px rgba(201,145,13,0.2)",
